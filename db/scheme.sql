...
values('c2ba5540514c11dfbead000e35b49aba', 'º“–£ª•¡™ Control file');
...
values('c2ba5540514c11dfbead000e35b49aba', 'Login', 1, 'µ«¬º≤‚ ‘');

insert into at_action(id, control_id, name, action_order, description)
values(2, 'c2ba5540514c11dfbead000e35b49aba', 'Message', 2, '∂Ã–≈œ‰≤‚ ‘');
...
values('ebb92cf0514c11dfbfa9000e35b49aba', 1, 'SendMessage', '∑¢ÀÕ¡Ù—‘');

insert into at_function(id, action_id, name, description)
values('1ce58621514d11df8231000e35b49aba', 1, 'GetMessage', 'ºÏ≤È¡Ù—‘');
